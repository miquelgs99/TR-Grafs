...
class SudokuColoringFrame(Main.StdFrame):
    ...
    def __init__(self):
        ...
        self.right_label = ttk.Label(top_text_frame, text='Coloring',
                                     foreground='#F0F0F0', font=('Segoe UI', 15))
        self.right_label.grid(column=0, row=0, padx=20)

        self.mid_label = ttk.Label(top_text_frame, text='Coloring', font=('Segoe UI', 20))
        self.mid_label.grid(column=1, row=0, padx=20)

        self.left_label = ttk.Label(top_text_frame, text='Sudoku', font=('Segoe UI', 15))
        self.left_label.grid(column=2, row=0, sticky=EW, padx=20)
        ...
        change_button = ttk.Button(text_frame, text="Change!", command=self.change_to)
        change_button.grid(column=1, row=2, padx=10, pady=10)
